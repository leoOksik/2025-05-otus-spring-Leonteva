...
public class JpaCommentRepositoryTest {
    ...
    void shouldReturnCorrectCommentById() {
        ...
        var actualComment = jpaCommentRepository.findById(GET_COMMENT_ID);
    ...
    void shouldReturnCorrectCommentByBookId() {
        var returnedComments = jpaCommentRepository.findByBookId(GET_COMMENT_BOOK_ID);
    ...
    void shouldCorrectUpdateComment() {
        ...
        var returnedComment = jpaCommentRepository.save(updatedComment);
    ...
    void shouldCorrectDeleteCommentById() {
        ...
        jpaCommentRepository.deleteById(DELETED_COMMENT_ID);
