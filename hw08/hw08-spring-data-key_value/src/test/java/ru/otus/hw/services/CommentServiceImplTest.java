...
@DisplayName("Сервис для работы с комментариями на основе MongoDB репозитория")
@DataMongoTest
...
class CommentServiceImplTest {
    ...
    void shouldReturnCommentByBookId() {
        ...
        var returnedComments = commentService.findByBookId(book.getId());
    ...
    void shouldSaveComment() {
        ...
        var savedComment = commentService.insert( "Comment_test", book.getId());
    ...
    void shouldUpdateComment() {
        ...
        commentService.update(savedComment.getId(),savedComment.getText(),savedComment.getBook().getId());
